...
components, kerning, curvature combs and harmonising, a `.fea` subset, and OTF, a variable OTF and UFO in
...
| 10    | Production polish                   | lint, format and 2019 tests, run on CI; preferences persist                         |
